...
with a public key is 245 byte, by default Strongbox uses a two layer
...
Strongbox's implementation drew inspiration from Thoughtbot's [Paperclip gem](https://github.com/thoughtbot/paperclip).
